...
word_freq_year = {
    2010: {'apple': 50, 'banana': 30, 'orange': 20, 'grape': 15, 'mango': 12,
           'pear': 10, 'peach': 8, 'melon': 7, 'kiwi': 6, 'pineapple': 5},
    2011: {'apple': 55, 'banana': 32, 'orange': 22, 'grape': 18, 'mango': 15,
           'pear': 12, 'peach': 10, 'melon': 9, 'kiwi': 7, 'pineapple': 6},
}

def generate_word_frq_yearlygif(yearly_wordfrq_dict):
    pass
...
# imageio.mimsave('word_freq_animation.gif', images, duration=1000)  # 每秒1帧
